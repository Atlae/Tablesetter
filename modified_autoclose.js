...
// @author       9003 + modifications from Atlae (suggested by Riemstagrad and Svenskskit)
...
( function() {
   ...
   if(window.location.href.endsWith("/pull_event_card")){
        ...
        var stuff;
         ...
         document.querySelector("input#new_price_value[name=\"new_price\"]").value='1.00';
       ...
       //.attr("action") + "/template-overall=none"
         ...
         document.getElementById("change_price_button").focus();
    }
