...
Then, run list_maker.py to generate a list in tep.html. **DO NOT RUN** delete_the_first_two_lines.sh. list_maker.py will do it for you. It's there to remove the first two extraneous lines which would otherwise cause trouble.
Then you should be able to go through that by clicking enter and such.
